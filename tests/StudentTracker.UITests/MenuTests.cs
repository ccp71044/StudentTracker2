...
public class MenuTests : IClassFixture<AppUiTestFixture>, IDisposable
{
    ...
    [InlineData("ViewMenu", "ViewMenu_Dashboard")]
    [InlineData("ViewMenu", "ViewMenu_Students")]
    [InlineData("ViewMenu", "ViewMenu_Courses")]
    [InlineData("ViewMenu", "ViewMenu_Deliveries")]
    [InlineData("ViewMenu", "ViewMenu_Allocations")]
    [InlineData("ViewMenu", "ViewMenu_Certificates")]
    [InlineData("ViewMenu", "ViewMenu_CreditsBudgets")]
    [InlineData("ViewMenu", "ViewMenu_Documents")]
    [InlineData("ViewMenu", "ViewMenu_Completions")]
    [InlineData("ViewMenu", "ViewMenu_Reports")]
    [InlineData("ViewMenu", "ViewMenu_ImportExport")]
    [InlineData("ViewMenu", "ViewMenu_Settings")]
